...
- A: Factory Method creates a *single* product using an overriden method in a subclass. Abstract Factory creates a *family* of related products using an object with multiple creation methods.
