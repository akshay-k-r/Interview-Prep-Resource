...
flowchart TB
    subgraph Document["Document Store - MongoDB"]
        D1["Collection: Users"]
        D2["Document: { user_id, name, orders: [...] }"]
    end

    subgraph KV["Key-Value Store - Redis"]
        K1["Key: session:abc123"]
        K2["Value: serialized JSON blob"]
    end
    ...
    %% Styles
    classDef docStyle fill:#d4edda,stroke:#28a745,stroke-width:2px,color:#155724;
    classDef kvStyle fill:#f8d7da,stroke:#dc3545,stroke-width:2px,color:#721c24;
    classDef wcStyle fill:#d1ecf1,stroke:#17a2b8,stroke-width:2px,color:#0c5460;
    classDef graphStyle fill:#fff3cd,stroke:#ffc107,stroke-width:2px,color:#856404;

    class D1,D2 docStyle;
    class K1,K2 kvStyle;
    class W1,W2 wcStyle;
...
flowchart LR
    ...
    classDef node fill:#fff3cd,stroke:#ffc107,stroke-width:2px,color:#856404;
