...
graph TD
    ...
    style Performing fill:#d4edda,stroke:#28a745,stroke-width:2px,color:black
    style Storming fill:#f8d7da,stroke:#dc3545,stroke-width:2px,color:black
    style Norming fill:#fff3cd,stroke:#ffc107,stroke-width:2px,color:black
    style Forming fill:#cfe2ff,stroke:#0d6efd,stroke-width:2px,color:black
```
