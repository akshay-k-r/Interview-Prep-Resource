...
graph TD
    ...
    style Decider fill:#d4edda,stroke:#28a745,stroke-width:2px,color:black
    style Approver fill:#fff3cd,stroke:#ffc107,stroke-width:2px,color:black
    style Recommender fill:#cfe2ff,stroke:#0d6efd,stroke-width:2px,color:black
    style Performer fill:#d4edda,stroke:#28a745,stroke-width:2px,color:black
```
